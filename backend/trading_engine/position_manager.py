...
class PositionManager:
    ...
    def _create_position_info(self, trade: Trade) -> Optional[PositionInfo]:
        ...
        try:
            ...
            return PositionInfo(
                ...
                days_held=days_held,
                max_profit=0.0,  # TODO: Trackear máximo profit
                max_loss=0.0,    # TODO: Trackear máxima pérdida
    ...
    def execute_position_close(self, position: PositionInfo, reason: str) -> bool:
        """🎯 Ejecutar cierre de posición (método legacy)
        ...
        Returns:
            True si se cerró correctamente
        """
        return self.close_position(position.trade_id, position.current_price, reason)
